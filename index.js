...
// Telegram Bot Setup
const tgToken = "8720060738:AAG0n6nqgoVxYh6k3hLmO5JGREACgY23FGM";
...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await tgBot.sendMessage(chatId, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗚𝗣𝗥𝗔𝗜𝗦𝗘 𝗕𝗢𝗧\n\n𝗘𝗡𝗧𝗘𝗥 𝗬𝗢𝗨𝗥 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗡𝗨𝗠𝗕𝗘𝗥\n(Example: 923000000000)");
        return;
    }
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("𝗚𝗣𝗥𝗔𝗜𝗦𝗘 𝗕𝗢𝗧")} 〕━━━┈⊷\n` +
                                                           ...
                                                           `🔗 ${toBold("𝗖𝗛𝗔𝗡𝗡𝗘𝗟:")}\n` +
                                                           `> *https://whatsapp.com/channel/0029VbBRPc3CMY0IePiiU808*\n` +
                                                           `⚡ ${toBold("𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: 𝗚𝗣𝗥𝗔𝗜𝗦𝗘")}`;
                                            try {
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("IM USING BEST BOT 𝗚𝗣𝗥𝗔𝗜𝗦𝗘 𝗕𝗢𝗧-BOT", 'utf-8') }]
                            });
